                   ...
                   Container(
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(_homeProvider.currentLang=="ar"?"زائر":"Guest",style: TextStyle(color: Colors.black,fontSize: 18)),
                        Text(_homeProvider.currentLang=="ar"?"الحساب الشخصي":"Profile",style: TextStyle(color: Colors.black,fontSize: 16),),
                      ],
                    )
                  ],
                ),
