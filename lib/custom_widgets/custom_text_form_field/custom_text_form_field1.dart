...
this.enableHorizontalMargin:true,
  ...
  @override
  _CustomTextFormField1State createState() => _CustomTextFormField1State();
}
...
class _CustomTextFormField1State extends State<CustomTextFormField1> {
  ...
  Widget _buildTextFormField() {
    return TextFormField(
      ...
      style:
      TextStyle(color: omarColor, fontSize: 28, fontWeight: FontWeight.w400 ) ,
      decoration: InputDecoration(
          ...
          contentPadding: EdgeInsets.symmetric(horizontal: 22.0 ,vertical: 10),
