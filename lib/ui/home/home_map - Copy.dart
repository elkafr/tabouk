    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: <Widget>[
                                      ...
                                      builder: (context, homeProvider, child) {
                                        return InkWell(
                                          onTap: (){
                                            ...
                                            homeProvider
                                                .updateChangesOnCategoriesList1(index);

                                            homeProvider.setEnableSearch1(true);
                                            homeProvider.setEnableSearch(false);
                                            homeProvider.setEnableSearch2(false);
                                            ...
                                            _selectedModel=null;
                                            _selectedCity=null;
                                            _homeProvider.setSelectedSub1(_selectedSub);
                                            ...
                                            _subList1 = _homeProvider.getSubList1(enableSub: true,catId:_homeProvider.age!=''?_homeProvider.age:"6");
                  ...
                  return DropDownListSelector1(
                    ...
                    onChangeFunc: (newValue) {
                      ...
                      setState(() {
                        ...
                        _homeProvider.setEnableSearch1(true);
                        _homeProvider.setEnableSearch(false);
                        _homeProvider.setEnableSearch2(false);
          ...
          (_homeProvider.selectedCat!=null && _homeProvider.selectedCat.catId!="0")?SizedBox(height: _width*.01,):Text(""),
          ...
          Consumer<HomeProvider>(builder: (context, homeProvider, child) {
            return FutureBuilder<List<Ad>>(
                future: homeProvider.enableSearch1==true && homeProvider.enableSearch==false && homeProvider.enableSearch2==false
                    ...
                    case ConnectionState.done:
                      if (snapshot.hasError) {
                        ...
                        if (snapshot.data.length > 0) {
                          ...
                          return Container(
                            width: _width*.92,
                            height: snapshot.data.length >2?_height*.50:_height*.28,
          ...
          CustomButton(
            ...
            onPressedFunction: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => SectionAdsScreen(catId: _homeProvider.catId,adCatName: _homeProvider.catName,))
              );
          ...
          Container(
            alignment: _homeProvider.currentLang=="ar"?Alignment.centerRight:Alignment.centerLeft,
            child: Text(_homeProvider.currentLang=="ar"?"خدمات":"Services",style: TextStyle(fontSize: 15,color: omarColor,fontWeight: FontWeight.bold),),
          ...
          Consumer<HomeProvider>(builder: (context, homeProvider, child) {
            return FutureBuilder<List<Ad>>(
                future: homeProvider.enableSearch==true && homeProvider.enableSearch1==false && homeProvider.enableSearch2==false
                    ? Provider.of<HomeProvider>(context, listen: true)
                    .getAdsSearchList("1")
                    : Provider.of<HomeProvider>(context, listen: true)
                    .getAdsList("1"),
          ...
          Container(
            ...
            child: Text(_homeProvider.currentLang=="ar"?"معارض الصور":"Photo Galleries",style: TextStyle(fontSize: 15,color: omarColor,fontWeight: FontWeight.bold),),
            margin: EdgeInsets.only(right: _width*.02,left: _width*.02,top:  _width*.02),
          ),
         ...
         /* Container(
          ...
          Consumer<HomeProvider>(builder: (context, homeProvider, child) {
            return FutureBuilder<List<Ad>>(
                future: homeProvider.enableSearch2==true && homeProvider.enableSearch==false  && homeProvider.enableSearch1==false
                    ? Provider.of<HomeProvider>(context, listen: true)
                    .getAdsSearchList2("3")
                    : Provider.of<HomeProvider>(context, listen: true)
                    .getAdsList2("3"),
