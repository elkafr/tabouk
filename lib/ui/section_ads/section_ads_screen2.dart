...
class SectionAdsScreen2 extends StatefulWidget {
  final String catId;
  final String adCatName;

  const SectionAdsScreen2({Key key, this.catId, this.adCatName}) : super(key: key);
  @override
  _SectionAdsScreen2State createState() => _SectionAdsScreen2State();
}

class _SectionAdsScreen2State extends State<SectionAdsScreen2> with TickerProviderStateMixin{
        ...
        Container(
          ...
          child: FutureBuilder<List<Ad>>(
              future: _homeProvider.enableSearch==true
                  ? Provider.of<SectionAdsProvider>(context, listen: false)
                  .getAdsListByCity(_homeProvider.selectedCity!=null?_homeProvider.selectedCity.cityId:"")
