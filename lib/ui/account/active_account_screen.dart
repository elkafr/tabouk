...
class _ActiveAccountScreenState extends State<ActiveAccountScreen>
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Text(
                ...
                _authProvider.currentLang=="ar"?"ادخل الكود المرسل على هاتفك لتفعيل الحساب":"Enter the code sent on your phone to activate the account",
  ...
  Widget _buildRecoveryBtn() {
    return  CustomButton(
      btnLbl: _authProvider.currentLang=="ar"?"تفعيل":"Activate",
      onPressedFunction: () async {
        ...
        if (_formKey.currentState.validate()) {
          ...
          final results =
          await _apiProvider.post(Urls.ACTIVATION_ACCOUNT_URL + "?api_lang=${_authProvider.currentLang}", body: {
            "activation_code": _activationCode5+_activationCode4+_activationCode3+_activationCode2+_activationCode1,
          });
