...
class AddAd2Screen extends StatefulWidget {
  @override
  _AddAd2ScreenState createState() => _AddAd2ScreenState();
}

class _AddAd2ScreenState extends State<AddAd2Screen> with ValidationMixin {
  ...
  void didChangeDependencies() {
    ...
    if (_initialRun) {
      ...
      _categoryList = _homeProvider.getCategoryList2(categoryModel:  CategoryModel(isSelected:false ,catId: '0',catName:
      AppLocalizations.of(context).translate('total'),catImage: 'assets/images/all.png'),enableSub: false);

      _subList = _homeProvider.getCategoryList2(categoryModel:  CategoryModel(isSelected:false ,catId: '0',catName:
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: CustomTextFormField(
                hintTxt: _homeProvider.currentLang=="ar"?"السعر":"Price",
  ...
  Widget build(BuildContext context) {
    ...
    final appBar = AppBar(
      ...
      title:Text(_homeProvider.currentLang=="ar"?"اضافة معرض صور":"Add gallery",style: TextStyle(fontSize: 15,color: omarColor),),
      actions: <Widget>[
